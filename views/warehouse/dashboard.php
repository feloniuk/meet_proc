            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mt-2 mb-0"><?= is_array($active_production) ? count($active_production) : 0 ?></h2>
                    </div>
                    <div class="card-icon">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h2 class="mt-2 mb-0"><?= is_array($low_stock) ? count($low_stock) : 0 ?></h2>
                    </div>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <?php
                    ...
                    if (is_array($inventory)) {
                        foreach ($inventory as $item) {
                            $category = !empty($item['material_name']) ? explode(' ', $item['material_name'])[0] : 'Інше';
                ...
                <?php if (empty($categories)): ?>
                    <p class="text-center py-3">Немає даних про інвентаризацію</p>
                <?php else: ?>
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <?php foreach ($categories as $category => $data): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?= number_format($total_value > 0 ? ($data['value'] / $total_value * 100) : 0, 1) ?>%
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                            <tfoot>
                                <tr class="table-active">
                                    <th>Всього</th>
                                    <th><?= is_array($inventory) ? count($inventory) : 0 ?></th>
