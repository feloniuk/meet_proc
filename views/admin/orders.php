...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?= BASE_URL ?>/admin/createOrder" class="btn btn-success">
        ...
        <div class="card-body">
            <form action="<?= BASE_URL ?>/admin/orders" method="get" class="row g-3">
                ...
                <div class="col-12 d-flex justify-content-end">
                    <a href="<?= BASE_URL ?>/admin/orders" class="btn btn-outline-secondary me-2">Скинути</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="<?= BASE_URL ?>/admin/viewOrder/<?= $order['id'] ?>" class="btn btn-outline-info">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <?php if ($order['status'] === 'pending'): ?>
                                                <a href="<?= BASE_URL ?>/admin/editOrder/<?= $order['id'] ?>" class="btn btn-outline-primary">
